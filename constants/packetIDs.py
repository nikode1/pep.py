...
server_matchPlayerSkipped = 80
client_setAwayMessage = 81
server_userPanel = 82
irc_only = 83
client_userStatsRequest = 84
server_restart = 85
client_invite = 86
server_invite = 87
server_channelInfoEnd = 88
client_matchChangePassword = 89
server_matchChangePassword = 90
server_silenceEnd = 91
client_tournamentMatchInfoRequest = 92
server_userSilenced = 93
server_userPanelSingle = 94
server_userPresenceBundle = 95
client_userPanelRequest = 96
client_userPanelRequestAll = 97
client_userToggleBlockNonFriendPM = 98
server_userPMBlocked = 99
server_targetIsSilenced = 100
server_versionUpdateForced = 101 #Bancho is telling osu! to check for new versions.
server_switchServer = 102
server_accountRestricted = 103
server_rtx = 104
client_matchAbort = 105
