...
def handle(tornadoRequest):
	...
	try:
		...
		# Checks if the user is about to be restricted
		if userUtils.checkFlag(userID) is 1:
			responseToken.enqueue(serverPackets.notification("The admins thinks you are suspious. If you don't send us a liveplay within 3 days, we will restrict your account, and you'll be able to appeal in a month."))
